        ...
        <div class="x-body">
            ...
            <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <select id="dept_id" name="dept_id" class="valid" lay-filter="dept">
                            <c:forEach items="${requestScope.dept_list}" var="line" varStatus="stat">
                          <option value="${line.id}" <c:if test="${recruit.dept_id == line.id }">selected</c:if>>${line.name}</option>
                          </c:forEach>
                        </select>
                    </div>         
                </div>
                <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <select id="jobId" name="jobId" class="valid">
                              ...
                              <option value="${line.id}" <c:if test="${recruit.jobId == line.id }">selected</c:if>>${line.name}</option>
                              </c:forEach>
                            </select>
                        </div>         
                    </div>   
